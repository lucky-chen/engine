...
public class FlutterEngine {
     ...
     * #getDartExecutor()} and {@link
     * DartExecutor#executeDartEntrypoint(DartExecutor.DartEntrypoint)} to begin executing Dart code
     * within this {@code FlutterEngine}.
     *
     ...
     *
     * <p>The first {@code FlutterEngine} instance constructed per process will also load the
     * Flutter native library and start a Dart VM.
     *
     ...
     */
    public FlutterEngine(@NonNull Context context, @NonNull FlutterLoader flutterLoader,
            @NonNull FlutterJNI flutterJNI, @Nullable String[] dartVmArgs,
            boolean automaticallyRegisterPlugins) {
        this(context, flutterLoader, flutterJNI, new PlatformViewsController(), dartVmArgs,
                automaticallyRegisterPlugins);
    }
    ...
    public FlutterEngine(@NonNull Context context, @NonNull FlutterLoader flutterLoader,
            @NonNull FlutterJNI flutterJNI,
            @NonNull PlatformViewsController platformViewsController, @Nullable String[] dartVmArgs,
            boolean automaticallyRegisterPlugins) {
        this(context, flutterLoader, flutterJNI, platformViewsController, dartVmArgs,
                automaticallyRegisterPlugins, null);
    }
    ...
    public FlutterEngine(@NonNull Context context, @NonNull FlutterLoader flutterLoader,
        ...
        // TODO(mattcarroll): FlutterRenderer is temporally coupled to attach(). Remove that
     ...
     *
     * <p>The Flutter tool generates a class called GeneratedPluginRegistrant, which includes the
     * code necessary to register every plugin in the pubspec.yaml with a given {@code
     * FlutterEngine}. The GeneratedPluginRegistrant must be generated per app, because each app
     * uses different sets of plugins. Therefore, the Android embedding cannot place a compile-time
     * dependency on this generated class. This method uses reflection to attempt to locate the
     * generated file and then use it at runtime.
     *
    ...
    private void registerPlugins() {
        try {
            ...
            Log.w(TAG,
                    "Tried to automatically register plugins with FlutterEngine (" + this
     ...
     *
     * <p>Use the {@link DartExecutor} to connect any desired message channels and method channels
     ...
     *
     * <p>To render a Flutter UI that is produced by this {@code FlutterEngine}'s Dart code, attach
     * a
    ...
    /**
     * System channel that sends platform-oriented requests and information to Flutter, e.g.,
     * requests to play sounds, requests for haptics, system chrome settings, etc.
     */
    @NonNull
    ...
    /**
     * Plugin registry, which registers plugins that want to be applied to this {@code
     * FlutterEngine}.
     */
    @NonNull
